...
/**
 * @typedef {import('@interop/data-integrity-core').IZcap} IZcap
 */
 ...
 * @param {string|IZcap} options.capability - Either a string to invoke a root
 ...
 *   capability.
 * @param {ISigner} options.invocationSigner - An invocation signer
